...
当前目录有 403 条硬边、687 条研究路线包、1001 条替代可视边、19 条应用交汇边、7 条显式分支边和
88 条里程碑候选边；没有
...
开局建筑的开工门只看生产/产出/资源科技；枯枝、韧皮等施工材料科技不赠送。带 `starter.construction`
的石器建材采集营（枯枝、土坑、芦苇、草皮、毛石）零建材即可立营；其它建筑仍用这些货物作建造配方。
