...
绑定仍必须为 0。数值效果必须显式填写作用类别、机制说明与原生消费者；生成器不得按名称、家族、
...
经营性恢复，以及 `terrain|landform × sector` 地理适应。目录当前显式审查产生 116 条数值 term：
42 条全社会或部门影响、25 条精确物资产出、9 条精确物资投入、4 条居民物资消费、13 条自然资源
影响和 23 条地理×产业影响。没有数值 term 的科技仍可通过解锁、硬前置、替代入口、标签或应用边
