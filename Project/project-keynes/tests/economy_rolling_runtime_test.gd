...
func _run() -> void:
	...
	_expect("PKEC v31 saves at a daily committed boundary",
		bool(saved.get("ok", false)) and int(saved.get("schema", 0)) == 31)
	...
	_expect("PKCN v7 tax and treasury restore matches",
