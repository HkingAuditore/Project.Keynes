...
const CELL_SCHEMA: Array = [
	...
	{ name = &"cell.plant_available_water",       cpp_name = "cell_plant_available_water",       dtype = F32, track_prev = false, map_field = "plant_available_water_arr",       prev_field = "", owner = "climate.vegetation_dynamics" },
