...
const CELL_SCHEMA: Array = [
	...
	{ name = &"cell.res_wheat_reserve", cpp_name = "cell_res_wheat_reserve", dtype = F32, track_prev = false, map_field = "res_wheat_reserve_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_rice_reserve", cpp_name = "cell_res_rice_reserve", dtype = F32, track_prev = false, map_field = "res_rice_reserve_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_corn_reserve", cpp_name = "cell_res_corn_reserve", dtype = F32, track_prev = false, map_field = "res_corn_reserve_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_potato_reserve", cpp_name = "cell_res_potato_reserve", dtype = F32, track_prev = false, map_field = "res_potato_reserve_arr", prev_field = "", owner = "economy.resources" },
	...
	{ name = &"cell.res_rubber_tree_reserve", cpp_name = "cell_res_rubber_tree_reserve", dtype = F32, track_prev = false, map_field = "res_rubber_tree_reserve_arr", prev_field = "", owner = "economy.resources" },
	...
	{ name = &"cell.res_horses_reserve", cpp_name = "cell_res_horses_reserve", dtype = F32, track_prev = false, map_field = "res_horses_reserve_arr", prev_field = "", owner = "economy.resources" },
	...
	{ name = &"cell.res_spice_plants_reserve", cpp_name = "cell_res_spice_plants_reserve", dtype = F32, track_prev = false, map_field = "res_spice_plants_reserve_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_flax_reserve", cpp_name = "cell_res_flax_reserve", dtype = F32, track_prev = false, map_field = "res_flax_reserve_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_cotton_reserve", cpp_name = "cell_res_cotton_reserve", dtype = F32, track_prev = false, map_field = "res_cotton_reserve_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_cattle_reserve", cpp_name = "cell_res_cattle_reserve", dtype = F32, track_prev = false, map_field = "res_cattle_reserve_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_sheep_reserve", cpp_name = "cell_res_sheep_reserve", dtype = F32, track_prev = false, map_field = "res_sheep_reserve_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_pigs_reserve", cpp_name = "cell_res_pigs_reserve", dtype = F32, track_prev = false, map_field = "res_pigs_reserve_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_medicinal_herbs_reserve", cpp_name = "cell_res_medicinal_herbs_reserve", dtype = F32, track_prev = false, map_field = "res_medicinal_herbs_reserve_arr", prev_field = "", owner = "economy.resources" },
	...
	{ name = &"cell.res_wheat_extra_change", cpp_name = "cell_res_wheat_extra_change", dtype = F32, track_prev = false, map_field = "res_wheat_extra_change_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_rice_extra_change", cpp_name = "cell_res_rice_extra_change", dtype = F32, track_prev = false, map_field = "res_rice_extra_change_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_corn_extra_change", cpp_name = "cell_res_corn_extra_change", dtype = F32, track_prev = false, map_field = "res_corn_extra_change_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_potato_extra_change", cpp_name = "cell_res_potato_extra_change", dtype = F32, track_prev = false, map_field = "res_potato_extra_change_arr", prev_field = "", owner = "economy.resources" },
	...
	{ name = &"cell.res_rubber_tree_extra_change", cpp_name = "cell_res_rubber_tree_extra_change", dtype = F32, track_prev = false, map_field = "res_rubber_tree_extra_change_arr", prev_field = "", owner = "economy.resources" },
	...
	{ name = &"cell.res_horses_extra_change", cpp_name = "cell_res_horses_extra_change", dtype = F32, track_prev = false, map_field = "res_horses_extra_change_arr", prev_field = "", owner = "economy.resources" },
	...
	{ name = &"cell.res_spice_plants_extra_change", cpp_name = "cell_res_spice_plants_extra_change", dtype = F32, track_prev = false, map_field = "res_spice_plants_extra_change_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_flax_extra_change", cpp_name = "cell_res_flax_extra_change", dtype = F32, track_prev = false, map_field = "res_flax_extra_change_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_cotton_extra_change", cpp_name = "cell_res_cotton_extra_change", dtype = F32, track_prev = false, map_field = "res_cotton_extra_change_arr", prev_field = "", owner = "economy.resources" },
	{ name = &"cell.res_cattle_extra_change", cpp_name = "cell_res_cattle_extra_change", dtype = F32, track_prev = false, map_field = "res_cattle_extra_change_arr", prev_field = "", owner = "economy.resources" },
