...
| Population, market, buildings, prosperity/settlement identity, taxable events and fiscal escrow | PKEC / `NativeEconomyRuntime` | PKSV `pkec` / PKEC v24 | Restore only after PKCN and trade topology |
