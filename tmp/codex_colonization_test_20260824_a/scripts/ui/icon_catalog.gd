...
const SPECS := {
	...
	&"family.workspace.crest": {"family": &"project_keynes",
		"texture": preload("res://assets/ui/family_workspace/bitmap/crest_bitmap.tres")},
	&"family.workspace.prestige": {"family": &"project_keynes",
		"texture": preload("res://assets/ui/family_workspace/bitmap/prestige_bitmap.tres")},
	&"family.workspace.person": {"family": &"project_keynes",
		"texture": preload("res://assets/ui/family_workspace/bitmap/person_bitmap.tres")},
	&"family.workspace.overview": {"family": &"project_keynes",
		"texture": preload("res://assets/ui/family_workspace/bitmap/nav_overview_bitmap.tres")},
	&"family.workspace.traits": {"family": &"project_keynes",
		"texture": preload("res://assets/ui/family_workspace/bitmap/nav_traits_bitmap.tres")},
	&"family.workspace.preferences": {"family": &"project_keynes",
		"texture": preload("res://assets/ui/family_workspace/bitmap/nav_preferences_bitmap.tres")},
	&"family.workspace.effects": {"family": &"project_keynes",
		"texture": preload("res://assets/ui/family_workspace/bitmap/nav_effects_bitmap.tres")},
	&"family.workspace.people": {"family": &"project_keynes",
		"texture": preload("res://assets/ui/family_workspace/bitmap/nav_people_bitmap.tres")},
	&"family.workspace.branches": {"family": &"project_keynes",
		"texture": preload("res://assets/ui/family_workspace/bitmap/nav_branches_bitmap.tres")},
	&"family.metric.population": {"family": &"project_keynes",
		"texture": preload("res://assets/ui/family_workspace/bitmap/metric_population_bitmap.tres")},
	&"family.metric.wealth": {"family": &"project_keynes",
		"texture": preload("res://assets/ui/family_workspace/bitmap/metric_wealth_bitmap.tres")},
	&"family.metric.buildings": {"family": &"project_keynes",
		"texture": preload("res://assets/ui/family_workspace/bitmap/metric_buildings_bitmap.tres")},
	&"family.metric.time": {"family": &"project_keynes",
		"texture": preload("res://assets/ui/family_workspace/bitmap/metric_time_bitmap.tres")},
