...
**PKEC v45**, configurable cross-domain effects are **PKEF v11**, Trigger state is
...
现金/商品审计包含国家资产、贸易托管与开拓货物托管。当前持久格式为 PKCN v11 + PKEC v45，必须先恢复 PKCN 与 PKEF；
