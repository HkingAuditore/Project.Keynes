...
const ConstructionOptionRowScene := preload(
	"res://scenes/ui/construction_option_row.tscn")
...
func _ready() -> void:
	...
	_rows_scroll = get_node("Margin/Root/RowsScroll") as ScrollContainer
	_rows = get_node("Margin/Root/RowsScroll/Rows") as VBoxContainer
...
func _apply_model() -> void:
	...
	for raw in items:
		...
		var button := ConstructionOptionRowScene.instantiate() as Button
		button.call("set_option", item)
