...
- narrow terrain/building/method: roughly +35% to +50%;
- building family: roughly +18% to +28%;
- broad country output/research/trade: roughly +12% to +15% per identity node;
- climate-loss reduction: roughly 8% per identity node, stacking toward 80%;
