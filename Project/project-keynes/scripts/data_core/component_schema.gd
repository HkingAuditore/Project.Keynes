...
const CELL_SCHEMA: Array = [
	...
	{ name = &"cell.res_fresh_water_reserve", cpp_name = "cell_res_fresh_water_reserve", dtype = F32, track_prev = false, map_field = "res_fresh_water_reserve_arr", prev_field = "", owner = "economy.resources" },
	...
	{ name = &"cell.res_freshwater_fish_reserve", cpp_name = "cell_res_freshwater_fish_reserve", dtype = F32, track_prev = false, map_field = "res_freshwater_fish_reserve_arr", prev_field = "", owner = "economy.resources" },
	...
	{ name = &"cell.res_uranium_ore_reserve", cpp_name = "cell_res_uranium_ore_reserve", dtype = F32, track_prev = false, map_field = "res_uranium_ore_reserve_arr", prev_field = "", owner = "economy.resources" },
	...
	{ name = &"cell.res_nickel_ore_reserve", cpp_name = "cell_res_nickel_ore_reserve", dtype = F32, track_prev = false, map_field = "res_nickel_ore_reserve_arr", prev_field = "", owner = "economy.resources" },
	...
	{ name = &"cell.res_fresh_water_extra_change", cpp_name = "cell_res_fresh_water_extra_change", dtype = F32, track_prev = false, map_field = "res_fresh_water_extra_change_arr", prev_field = "", owner = "economy.resources" },
	...
	{ name = &"cell.res_freshwater_fish_extra_change", cpp_name = "cell_res_freshwater_fish_extra_change", dtype = F32, track_prev = false, map_field = "res_freshwater_fish_extra_change_arr", prev_field = "", owner = "economy.resources" },
	...
	{ name = &"cell.res_uranium_ore_extra_change", cpp_name = "cell_res_uranium_ore_extra_change", dtype = F32, track_prev = false, map_field = "res_uranium_ore_extra_change_arr", prev_field = "", owner = "economy.resources" },
	...
	{ name = &"cell.res_nickel_ore_extra_change", cpp_name = "cell_res_nickel_ore_extra_change", dtype = F32, track_prev = false, map_field = "res_nickel_ore_extra_change_arr", prev_field = "", owner = "economy.resources" },
