...
inline constexpr BindEntry BIND_TABLE_AUTOGEN[] = {
    ...
    { "cell_res_spice_plants_reserve",         "res_spice_plants_reserve_arr",         SlotDType::F32 },
    { "cell_res_flax_reserve",                 "res_flax_reserve_arr",                 SlotDType::F32 },
    { "cell_res_cotton_reserve",               "res_cotton_reserve_arr",               SlotDType::F32 },
    ...
    { "cell_res_medicinal_herbs_reserve",      "res_medicinal_herbs_reserve_arr",      SlotDType::F32 },
    ...
    { "cell_res_spice_plants_extra_change",    "res_spice_plants_extra_change_arr",    SlotDType::F32 },
    { "cell_res_flax_extra_change",            "res_flax_extra_change_arr",            SlotDType::F32 },
    { "cell_res_cotton_extra_change",          "res_cotton_extra_change_arr",          SlotDType::F32 },
