...
const SECTION_ECONOMY_POD := 1024
const SECTION_ECONOMY_ECP2 := 2048
const SECTION_GAMEPLAY_EFFECT := 4096
const SECTION_KNOWN := SECTION_RUNTIME_ENVELOPE | SECTION_DOMAIN_POD | SECTION_CLIMATE \
	...
	| SECTION_IDEOLOGY | SECTION_ECONOMY_ASSET | SECTION_ECONOMY_POD \
	| SECTION_ECONOMY_ECP2 | SECTION_GAMEPLAY_EFFECT
