...
## Discovery controls information visibility. Research routes are authored as
## named condition branches and compiled together with prerequisites into one
## research eligibility condition by TechnologyCatalog.
