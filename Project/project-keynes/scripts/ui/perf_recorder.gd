...
const FIXED_COLUMNS: Array = [
	...
	"clock_loop_ms",
	"clock_full_ms",
	"clock_day_cost_ema_ms",
	"clock_throughput_cap",
	"clock_last_advanced_days",
	# Host day_changed segments. These are the most recent clock-day callback,
	# not the lagged clock_loop column. Process columns are sums since the
	# previous perf row.
	"sched_day_total_ms",
	"sched_day_report_ms",
	"sched_day_snapshots_ms",
	"sched_day_climate_writeback_ms",
	"sched_day_climate_wait_ms",
	"sched_day_capture_ms",
	"sched_day_country_peer_ms",
	"sched_day_country_read_ms",
	"sched_day_promote_ms",
	"sched_proc_frames",
	"sched_proc_economy_input_ms",
	"sched_proc_peer_ms",
	"sched_proc_snapshots_ms",
	"sched_proc_country_read_ms",
	"sched_proc_country_visual_ms",
	"sched_proc_commit_ms",
	"sched_proc_resource_ms",
	"sched_proc_visual_ms",
	"sched_proc_building_ms",
	"sched_proc_overlay_ms",
	"sched_proc_last_total_ms",
	"country_read_full_snapshot_applied",
	"country_read_applied_cells",
	"country_read_territory_changed_cells",
	"country_read_full_snapshot_count",
	"country_read_patch_count",
	"country_read_rejected_count",
	"country_visual_last_refresh_ms",
	"country_visual_refresh_pending",
	"country_visual_refresh_deferred_frames",
	"country_visual_refresh_run_count",
	"country_visual_refresh_defer_count",
	...
	# Cumulative worker-time counters: compare deltas across rows.
	"runtime_graph_worker_time_execute_us",
	"runtime_graph_worker_time_input_wait_us",
	"runtime_graph_worker_time_clock_wait_us",
	"runtime_graph_worker_time_boundary_wait_us",
	"runtime_graph_worker_time_overhead_us",
	"runtime_graph_worker_time_total_us",
	"runtime_graph_input_capture_count",
	"runtime_graph_input_capture_reused",
	"runtime_graph_economy_input_requested_day",
	"runtime_graph_country_worker_waiting_for_peer",
	"runtime_graph_country_worker_pending_intents",
	"runtime_graph_country_worker_queued_intents",
	"runtime_graph_country_worker_last_reason",
	"runtime_graph_country_worker_day",
	"runtime_graph_country_worker_continuation_index",
	# Tax/subsidy probe published by the economy worker. Millisecond fields are
	# epoch accumulators and drop back to 0 when the epoch metrics clear.
	# negative_tax_mask bit 0 is income subsidy.
	"runtime_graph_economy_yield_reason",
	"runtime_graph_economy_stage_name",
	"runtime_graph_economy_substage_name",
	"runtime_graph_economy_epoch_fiscal_ms",
	"runtime_graph_economy_fiscal_settlement_ms",
	"runtime_graph_economy_income_subsidy_ms",
...
func on_fast_tick(sample: Dictionary) -> void:
	...
	if runtime_graph is Dictionary:
		for key in ["pulse_count", "abi_calls", "gdscript_callbacks", "work_done",
				...
				"country_pod_blocker",
				"worker_time_execute_us", "worker_time_input_wait_us",
				"worker_time_clock_wait_us", "worker_time_boundary_wait_us",
				"worker_time_overhead_us", "worker_time_total_us",
				"input_capture_count", "input_capture_reused",
				"economy_input_requested_day",
				"country_worker_waiting_for_peer",
				"country_worker_pending_intents",
				"country_worker_queued_intents",
				"country_worker_last_reason",
				"country_worker_day",
				"country_worker_continuation_index",
				"economy_yield_reason", "economy_stage_name",
				"economy_substage_name",
