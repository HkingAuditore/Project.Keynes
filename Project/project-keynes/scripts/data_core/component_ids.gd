...
## 视野迷雾三态的两个权威位（VisionSolver 写）。visible ⊆ explored。
const CELL_VISIBLE: StringName = &"cell.visible"
const CELL_EXPLORED: StringName = &"cell.explored"
...
const CELL_RES_PASTURE_RESERVE: StringName = &"cell.res_pasture_reserve"
...
const CELL_RES_PASTURE_EXTRA_CHANGE: StringName = &"cell.res_pasture_extra_change"
