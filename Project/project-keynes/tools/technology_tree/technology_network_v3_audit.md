...
- Nodes: 705
- Branch families: 24
- Hard prerequisite edges: 2460 (no indegree cap)
...
- 玉米与园圃农业 (`branch.maize_horticulture`): 21 nodes
- 小麦、谷物与雨养农业 (`branch.wheat_rainfed`): 35 nodes
- 水稻、水田与灌溉农业 (`branch.rice_irrigation`): 24 nodes
- 块茎、梯田与高地农业 (`branch.tuber_highland`): 21 nodes
- 草原、马匹与畜牧业 (`branch.pastoral_livestock`): 34 nodes
- 热带作物与商品农业 (`branch.tropical_commodities`): 35 nodes
- 森林、木材、造纸与生物质 (`branch.forest_biomass`): 14 nodes
- 渔业、航海、港口与海运物流 (`branch.maritime_logistics`): 19 nodes
- 纤维、纺织、服装与合成纤维 (`branch.textile_fibers`): 32 nodes
...
- 劳工、管理与生产组织 (`branch.labor_management`): 43 nodes
- 测量、标准化与精密仪器 (`branch.measurement_instruments`): 15 nodes
- 自然史、生物学与育种科学 (`branch.natural_history`): 17 nodes
- 医学、卫生与公共健康 (`branch.public_health`): 12 nodes
- 制图、地学、遥感与空间分析 (`branch.geoscience_gis`): 19 nodes
- 计算、控制、网络与机器智能 (`branch.computation_control`): 31 nodes
