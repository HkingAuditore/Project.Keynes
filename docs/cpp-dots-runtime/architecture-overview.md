...
已发运订单不因后续边界变化取消。当前 PKCN v3 保存国家状态、研究状态与 Country Modifier domain，
PKEC v22 引用匹配的 PKCN identity，并持久化经济状态、科研采购累计、BuildingIdentityStore、Economy
Modifier domain 与生产气候冻结/诊断字段；完整恢复顺序固定为 PKCM、PKCN、PKEC、PKGP。详见
