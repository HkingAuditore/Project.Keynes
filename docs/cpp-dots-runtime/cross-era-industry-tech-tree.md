...
- 野生动物保留为早期生态资源：`wild_game -> game_meat/raw_hide/fur`，由 `stone_age_hunting_camp` 产出，农业时代后重要性下降。石器营地按 80% 保守售出率校准为 `1060/265/106` GOODS_SCALE/栋/日产出野味、生皮和毛皮，保持手工配方的肉/皮/毛比例；`715` 野生动物扣减对应约 `2:1` 的总产出/采收效率。
