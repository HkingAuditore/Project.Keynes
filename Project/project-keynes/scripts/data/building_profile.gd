...
## Optional parallel construction constraints. Empty category IDs preserve
## exact-good recipes. A category group accepts every technology-available good
## in that category whose production quality meets the minimum; its good-level
